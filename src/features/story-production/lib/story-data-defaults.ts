...
export function createDemoStoryData(storyId = "GNN-DEMO-001"): StoryDataRecord {
  return {
    ...
    summary:
      "ഗുഡ് ന്യൂസ് ഫ്ലാഷ് സംഘടിപ്പിച്ച സമൂഹ സാക്ഷാത്കാര പരിപാടിയിൽ ആയിരം പേർ പങ്കെടുത്തു. സമൂഹത്തിലെ പോസിറ്റീവ് വാർത്തകൾ ശേഖരിക്കുന്നതിനുള്ള ഈ പദ്ധതി വ്യാപകമായ പ്രതികരണം നേടി.",
