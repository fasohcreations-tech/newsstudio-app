-- =============================================================================
-- MediaOS – Organization bootstrap RLS fix
-- Migration: 20260324000003_org_bootstrap
--
-- Problem: INSERT into organizations succeeds, but RETURNING/SELECT is blocked
-- because organizations_select_member requires is_org_member() before the
-- creator has a membership row.
--
-- Fix: SECURITY DEFINER bootstrap that creates org + owner membership +
-- default workspace atomically.
--
-- NOTE: 20260324000004 replaces this function to also ensure profiles exist.
-- Keep this file for ordered history; 00004 is the authoritative definition.
-- =============================================================================
